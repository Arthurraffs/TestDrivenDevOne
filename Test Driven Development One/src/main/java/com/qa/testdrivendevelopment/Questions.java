...
public class Questions {
	...
	public boolean endsJava(String input) {
		...
		String j = "java";	
		if (input1.endsWith(j)) {
			System.out.println(input + " ends with Java.");
			return true;
		}
		
		System.out.println(input + " does not end with Java.");
    	return false;
	}
	...
	public int amISearch(String sentence) {
		...
		System.out.println(sentence + " contains am " + count + " times.");
		return count;
...
//			
//			count++;
//			lastIndex = sentence1.indexOf(s, lastIndex);
//			
//			System.out.println(sentence + " contains am " + count + "times.");
//		}
//		
